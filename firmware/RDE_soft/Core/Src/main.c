...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* ── LED_G heartbeat – toggle every 500 ms (1 Hz blink) ── */
    ...
    if (usb_now && !usb_prev) {
        tud_connect();
    } else if (!usb_now && usb_prev) {
        tud_disconnect();
    }
    usb_prev = usb_now;

    /* ── USB tasks (only while VUSB present) ── */
    if (usb_now) {
        tud_task();
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, REL_EN_Pin|REL_RCK_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED_G_Pin|LED_R_Pin|W5500_RST_Pin|W5500_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : REL_EN_Pin REL_RCK_Pin */
  GPIO_InitStruct.Pin = REL_EN_Pin|REL_RCK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : LED_G_Pin LED_R_Pin W5500_RST_Pin W5500_CS_Pin */
  GPIO_InitStruct.Pin = LED_G_Pin|LED_R_Pin|W5500_RST_Pin|W5500_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : W5500_INT_Pin USB_DETECT_Pin */
  GPIO_InitStruct.Pin = W5500_INT_Pin|USB_DETECT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : W5500_CLK_Pin */
